...
# verify a user bucket and key are passed in
if [ "$#" -ne 3 ]; then
...
echo curl -X GET ${CURL_TLS_OPT} -u"$1:XXXXXX" "${PROTO}://localhost:10018/buckets/$2/keys/$3"
curl -X GET ${CURL_TLS_OPT} -u"$1:123456" "${PROTO}://localhost:10018/buckets/$2/keys/$3"
echo